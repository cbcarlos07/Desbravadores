 ...
 * @author Gysa
 */
public class TelaAdmDivisao extends javax.swing.JInternalFrame {

    /**
     * Creates new form TelaDivisao
     */
    public TelaAdmDivisao() {
        initComponents();
    ...
    private void initComponents() {
        ...
        grupo.add(jrDivisao);
        jrDivisao.setSelected(true);
        jrDivisao.setText("Divisão");
        ...
        tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Divisão", "Sigla", "Principal"
            }
        ) {
    ...
    private void jb_alterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jb_alterarActionPerformed
        ...
        cadastro(Integer.parseInt(tabela.getValueAt(tabela.getSelectedRow(), 0).toString()),
                ...
                tabela.getValueAt(tabela.getSelectedRow(), 3).toString());
    ...
    static Divisao divisao;
    static Divisao_Controller divisao_Controller;
    static List lista;
    ...
    private void selecao(){
        if(jrDivisao.isSelected()){
            pesquisaDivisao(jt_pesquisar.getText().trim());
        }else{
            pesquisaSigla(jt_pesquisar.getText().trim());
        }
    }
    
    public static void pesquisaDivisao(String texto){
        Cursor.getPredefinedCursor(3);
        divisao_Controller = new Divisao_Controller();
        lista = divisao_Controller.getDivisaoList(texto);
        preencherTabela();
    ...
    public static void pesquisaSigla(String texto){
        Cursor.getPredefinedCursor(3);
        divisao_Controller = new Divisao_Controller();
        lista = divisao_Controller.getSiglaList(texto);
        preencherTabela();
        Cursor.getDefaultCursor();
    }
    ...
    private static void preencherTabela(){
        ...
        while(iterator.hasNext()){
            ...
            linha.addRow(new Object[]{
               divisao.getDiv_Codigo(),
               divisao.getDiv_Nome(),
               divisao.getDiv_Sigla(),
               divisao.getSn_principal()
            });
        }
    }
  private void cadastro(int codigo, String divi, String sigla, String principal){
      TelaCadDivisao tela = new TelaCadDivisao(codigo, divi, sigla, principal);
  ...
  private void excluir(){
      divisao_Controller =  new Divisao_Controller();
      boolean teste = divisao_Controller.excluir(
