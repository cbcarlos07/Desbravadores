 ...
 * @author Gysa
 */
public class TelaAdmTipo_Contato extends javax.swing.JInternalFrame {

    /**
     * Creates new form TelaTipo_Contato
     */
    public TelaAdmTipo_Contato() {
        initComponents();
        jt_pesquisar.requestFocus();
        pesquisaTipo_Contato("");
    ...
    private void initComponents() {
        ...
        setResizable(true);
        setTitle("Tipo de Contato do Pastor");
        ...
        jLabel1.setText("Digite o tipo de contato para pesquisar");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jt_pesquisar, javax.swing.GroupLayout.PREFERRED_SIZE, 144, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(27, 27, 27)
    ...
    private void jb_pesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jb_pesquisarActionPerformed
        pesquisaTipo_Contato(jt_pesquisar.getText());
        ativaDesativa(0);
    ...
    static Tipo_Contato tipo_Contato;
    static Tipo_Contato_Controller tipo_Contato_Controller;
    static List lista;
    static Iterator iterator;
    
    
    public static void pesquisaTipo_Contato(String texto){
        Cursor.getPredefinedCursor(3);
        tipo_Contato_Controller = new Tipo_Contato_Controller();
        lista = tipo_Contato_Controller.getTipo_ContatoList(texto);
        preencherTabela();
    ...
    private static void preencherTabela(){
        ...
        while(iterator.hasNext()){
            tipo_Contato = (Tipo_Contato) iterator.next();
            linha.addRow(new Object[]{
               tipo_Contato.getTipo_Contato_Codigo(),
               tipo_Contato.getTipo_Contato_Descricao()
            });
        }
    }
  private void cadastro(int codigo, String divi){
      TelaCadTipo_Contato tela = new TelaCadTipo_Contato(codigo, divi);
  ...
  private void excluir(){
      tipo_Contato_Controller =  new Tipo_Contato_Controller();
      boolean teste = tipo_Contato_Controller.excluir(
