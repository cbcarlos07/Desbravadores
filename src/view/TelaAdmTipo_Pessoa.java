 ...
 * @author Gysa
 */
public class TelaAdmTipo_Pessoa extends javax.swing.JInternalFrame {

    /**
     * Creates new form TelaTipo_Pessoa
     */
    public TelaAdmTipo_Pessoa() {
        initComponents();
        jt_pesquisar.requestFocus();
        setTitle("Tipo de Pessoa");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Digite o tipo de pessoa para pesquisar");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(jt_pesquisar, javax.swing.GroupLayout.PREFERRED_SIZE, 181, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jb_pesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jb_pesquisarActionPerformed
        pesquisaTipo_Pessoa(jt_pesquisar.getText());
        ativaDesativa(0);
    ...
    static Tipo_Pessoa tipo_Pessoa;
    static Tipo_Pessoa_Controller tipo_Pessoa_Controller;
    static List lista;
    static Iterator iterator;
    
    
    public static void pesquisaTipo_Pessoa(String texto){
        Cursor.getPredefinedCursor(3);
        tipo_Pessoa_Controller = new Tipo_Pessoa_Controller();
        lista = tipo_Pessoa_Controller.getTipo_PessoaList(texto);
        preencherTabela();
    ...
    private static void preencherTabela(){
        ...
        while(iterator.hasNext()){
            tipo_Pessoa = (Tipo_Pessoa) iterator.next();
            linha.addRow(new Object[]{
               tipo_Pessoa.getTipo_Pessoa_Codigo(),
               tipo_Pessoa.getTipo_Pessoa_Descricao()
            });
        }
    }
  private void cadastro(int codigo, String divi){
      TelaCadTipo_Pessoa tela = new TelaCadTipo_Pessoa(codigo, divi);
  ...
  private void excluir(){
      tipo_Pessoa_Controller =  new Tipo_Pessoa_Controller();
      boolean teste = tipo_Pessoa_Controller.excluir(
