 ...
 * @author Gysa
 */
public final class TelaAdmCidade extends javax.swing.JInternalFrame {
    int cod_estado;
    String nm_estado;
    /**
     * Creates new form TelaCidade
     */
    public TelaAdmCidade() {
        initComponents();
    ...
    private void jb_pesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jb_pesquisarActionPerformed
        ...
        cd_estado = estado.getEstado_Codigo();
        }catch(Exception e){}
        if(cd_estado > 0){
            pesquisaCidade(jt_pesquisar.getText(), cd_estado);
        }else{
            pesquisaCidade(jt_pesquisar.getText());
        }
    ...
    static Cidade_Controller cidade_Controller;
    static List lista;
    static Iterator iterator;
    
    
    public static void pesquisaCidade(String texto){
        Cursor.getPredefinedCursor(3);
        cidade_Controller = new Cidade_Controller();
        lista = cidade_Controller.getCidadeList(texto);
        preencherTabela();
        Cursor.getDefaultCursor();
    }
    
    public static void pesquisaCidade(String texto, int estado){
        Cursor.getPredefinedCursor(3);
        cidade_Controller = new Cidade_Controller();
        lista = cidade_Controller.getCidadeList(texto, estado);
        preencherTabela();
        Cursor.getDefaultCursor();
    }
    ...
    private static void preencherTabela(){
        ...
        while(iterator.hasNext()){
            ...
            linha.addRow(new Object[]{
               cidade.getCidade_Codigo(),
               cidade.getCidade_Descricao(),
               //cidade.getEstado().getEstado_Nome(),
               cidade.getCidade_sn_principal()
               
            });
        }
    }
  private void cadastro(int codigo, String divi){
      TelaCadCidade tela = new TelaCadCidade(codigo);
  ...
  private void excluir(){
      cidade_Controller =  new Cidade_Controller();
      boolean teste = cidade_Controller.excluir(
