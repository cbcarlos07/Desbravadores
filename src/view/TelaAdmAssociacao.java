 ...
 * @author Gysa
 */
public class TelaAdmAssociacao extends javax.swing.JInternalFrame {

    /**
     * Creates new form TelaAssociacao
     */
    public TelaAdmAssociacao() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jrAssociacao = new javax.swing.JRadioButton();
        ...
        grupo.add(jrAssociacao);
        jrAssociacao.setSelected(true);
        jrAssociacao.setText(titulo);
        jrAssociacao.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jrAssociacaoActionPerformed(evt);
            }
        });
        ...
        tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Associação", "Sigla", "União", "Principal"
            }
        ) {
    ...
    private void jrAssociacaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jrAssociacaoActionPerformed
        jt_pesquisar.requestFocus();
    }//GEN-LAST:event_jrAssociacaoActionPerformed
    ...
    private javax.swing.JRadioButton jrAssociacao;
    ...
    static Associacao uniao;
    static Associacao_Controller uniao_Controller;
    static List lista;
    static Iterator iterator;
    String titulo =  "Associação";
    
    private void selecao(){
        if(jrAssociacao.isSelected()){
            pesquisaAssociacao(jt_pesquisar.getText().trim());
        }else{
            pesquisaSigla(jt_pesquisar.getText().trim());
        }
    }
    
    public static void pesquisaAssociacao(String texto){
        Cursor.getPredefinedCursor(3);
        uniao_Controller = new Associacao_Controller();
        lista = uniao_Controller.getAssociacaoList(texto);
        preencherTabela();
    ...
    private static void preencherTabela(){
        ...
        while(iterator.hasNext()){
            uniao = (Associacao) iterator.next();
            linha.addRow(new Object[]{
               uniao.getAssoc_Codigo(),
               uniao.getAssoc_Nome(),
               uniao.getAssoc_Sigla(),
               uniao.getUniao().getUniao_Nome(),
               uniao.getAssoc_sn_principal()
            });
        }
    }
  private void cadastro(int codigo){
      TelaCadAssociacao tela = new TelaCadAssociacao(codigo);
